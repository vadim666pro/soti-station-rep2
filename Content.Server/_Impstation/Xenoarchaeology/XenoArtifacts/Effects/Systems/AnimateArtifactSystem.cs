// using Content.Server.Xenoarchaeology.XenoArtifacts.Effects.Components; //Commented bc i have zero clue why is it here. (And this is commented on imp too) Prob-ly, came with revenant update. Bruh
