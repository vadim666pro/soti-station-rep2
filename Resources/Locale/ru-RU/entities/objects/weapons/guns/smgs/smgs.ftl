...
ent-WeaponSubMachineGunC20r = C-20r
    ...
    .suffix = Пистолет-пулемёт
ent-WeaponSubMachineGunDrozd = Фамас
    .desc = Крутое орудие спецназа. Было использовано в 2001 году при задержании Тони Путаны. Использует патроны калибра .35 авто.
